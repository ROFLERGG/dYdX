  ...
  return (
    <div>
      ...
      <label onClick={setIsOpenHandler} htmlFor={id + 1} className={`flex flex-col justify-center duration-150 overflow-hidden ${isOpen ? 'space-y-6' : ''} py-6 cursor-pointer`}>
        ...
        <div className={`origin-left ${isOpen ? 'w-fit max-h-96 transition-all opacity-100 scale-100 duration-150' : 'w-fit max-h-0 overflow-hidden scale-90 opacity-0 transition-all duration-150'}`}>
    ...
    <div className="flex flex-col space-y-20">
      ...
      <div className="flex flex-col space-y-6">
        <div className="flex justify-start">
          <h2 className="heading-md text-white-100">Grant application process</h2>
        </div>
