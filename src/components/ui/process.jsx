    ...
    ProcessCardData.map((data) => {
      return (
        <div className="relative">
          ...
          {data.arrow2 &&
            <img src={data.arrow2} alt="arrow1" className="absolute top-6 -left-24 max-md:w-[90px] max-md:h-[30px] max-md:rotate-90 max-md:left-4 max-md:-top-10"/>
          }
          {data.arrow3 &&
            <img src={data.arrow3} alt="arrow2" className="absolute -left-20 -bottom-6 max-md:w-[90px] max-md:h-[30px] max-md:rotate-90 max-md:-left-8 max-md:bottom-full"/>
          }
        </div>
      )
    })
