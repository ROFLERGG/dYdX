...
const tooltipVariants = cva('tooltip', {
  variants: {
    position: {
      ...
      right: 'before:left-full before:ml-3 before:inset-y-1/2 before:-translate-y-1/2 after:left-full after:inset-y-1/2 after:-translate-y-1/2 after:-ml-1 after:border-l-transparent after:border-t-transparent after:border-b-transparent',
      ...
      bottom: 'before:top-full before:mt-3 before:inset-x-1/2 before:-translate-x-1/2 after:top-full after:inset-x-1/2 after:-translate-x-1/2 after:-mt-1 after:border-l-transparent after:border-t-transparent after:border-r-transparent'
    }
  }
})

const Tooltip = ({ text, position, ...rest }) => {
  return <div data-tooltip={text} className={tooltipVariants({ position })} {...rest}/>
}
