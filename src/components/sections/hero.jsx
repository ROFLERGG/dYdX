...
const Hero = () => {
  return (
    <div className="relative py-[80px]">
        ...
        <div className="flex justify-center">
          <div className="flex flex-col max-w-[800px] space-y-[80px] max-sm:space-y-[40px]">
            <div className="flex flex-col space-y-[40px]">
              <h1 className="hero text-white-100 text-center">Powering the future of dYdX through community grants</h1>
      ...
      <svg className="absolute bottom-0 inset-x-1/2 -translate-x-1/2 translate-y-1/2 w-[32px] h-[100px] max-lg:w-[20px] max-lg:h-[50px]">
